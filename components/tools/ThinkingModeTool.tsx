...
interface ThinkingModeToolProps {
    onBack: () => void;
}
...
const ThinkingModeTool: React.FC<ThinkingModeToolProps> = ({ onBack }) => {
    const [messages, setMessages] = useState<Message[]>([
        { sender: 'ai', text: "You've entered Thinking Mode. I'll use a more advanced model to provide deeper insights. What complex topic is on your mind?" }
    ]);
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        const response = await generateThinkingResponse(currentInput);
    ...
    return (
        <div className="h-full flex flex-col p-4 md:p-8 bg-gray-50">
            ...
            <div className="text-center mb-4">
                <h1 className="text-3xl md:text-4xl font-bold text-gray-800">Thinking Mode</h1>
                <p className="text-gray-500 mt-2">For deep, complex, and nuanced conversations.</p>
            </div>
...
export default ThinkingModeTool;
